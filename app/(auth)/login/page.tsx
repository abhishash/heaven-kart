    ...
    <div className="flex h-screen w-full">~
          ...
          >
            ...
            <div className="flex flex-col gap-y-4">
              <Field className="flex flex-col gap-y-2">
                <FieldLabel htmlFor="input-email" className="font-medium text-gray-900">Email</FieldLabel>
                <Input
                  color="secondary"
                  id="input-email"
              ...
              <Field className="flex flex-col gap-y-2">
                <FieldLabel htmlFor="input-password" className="font-medium text-gray-900">Password</FieldLabel>
                <Input
                  color="secondary"
                  id="input-password"
                  {...register("password", {
      ...
      <div className="flex-1 px-6 w-full relative bg-white">
        <div className="flex items-center h-20 relative z-10 justify-end">
          <p className="MuiTypography-root MuiTypography-body1 font-medium text-primary-700  p-4">
            Not a User?
          </p>
          <button
            className="px-4 py-2 rounded-lg cursor-pointer text-white bg-linear-to-r from-[#3C006B] from-[7.58%] to-[#8C1D75] to-[98.88%] "
            type="button"
          >
          ...
          <div className="w-full px-4 flex-1 xl:pt-16">
            <div className="flex flex-col w-full items-center">
              <img
                ...
                className="h-18 w-18"
              />
              <h5 className="MuiTypography-root MuiTypography-h5 !font-medium !mt-4 text-gray-500 css-owt45">
                Grow your Business Faster By
              </h5>
              <h4 className="MuiTypography-root MuiTypography-h4 !font-semibold bg-clip-text text-transparent bg-gradient-to-r from-[#3C006B] from-[7.58%] to-[#8C1D75] to-[98.88%] css-iqeqln">
                Selling through Zepto
              </h4>
            </div>
            <div className="mt-8 grid grid-cols-2 gap-8">
              <div className="flex items-center">
                ...
                <div className="ml-4 flex flex-col">
                  <h5 className="MuiTypography-root MuiTypography-h5 !font-semibold bg-clip-text text-transparent bg-gradient-to-r from-[#3C006B] from-[7.58%] to-[#8C1D75] to-[98.88%] css-owt45">
                    55 Million+
                  </h5>
                  <p className="text-gray-500 text-sm font-medium leading-3">
